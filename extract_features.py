...
def parse_args():
    ...
    parser.add_argument('--output', type=str, default='./outputs', help='Extract Features')
...
def main():    
    ...
    # get img paths
    dataset = get_example_dataset_preprocess(index_file=args.index_file)
    ...
    for path_tuple in path_tuples:
        ...
        out_dir = join(args.output, rel_folder)
